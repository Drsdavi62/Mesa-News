...
interface NewsAPIInterface {
    ...
    fun getNews(@Header("Authorization") authToken : String) : Call<NewsResponseModel>

    @GET("/v1/client/news/highlights")
    fun getHighlights(@Header("Authorization") authToken : String) : Call<NewsResponseModel>
